;; JavaScript treats all numbers as 64-bit floating-point
;; numbers. When you call a JavaScript function from WebAssembly, the
;; JavaScript engine will perform an implicit conversion to a 64-bit float, no
;; matter what data type you pass.
