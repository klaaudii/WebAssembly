const fs = require('fs');
const bytes = fs.readFileSync(__dirname +'/memory_object.wasm');
// allocate a 64K block of memory
const memory = new WebAssembly.Memory({initial: 1 });
// 32-bit data view of the memory buffer, This means that each
// group of 4 bytes in the buffer is considered to represent a 
